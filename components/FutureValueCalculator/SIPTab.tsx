...
const SIPTab: React.FunctionComponent<SIPTabProps> = () => {
  ...
  const [investedAmount, setInvestedAmount] = React.useState<number>(15000);
  const [interestRate, setInterestRate] = React.useState<number>(25.04);
  ...
  const handleCalculate = () => {
    const fv = getFutureValue(months, investedAmount, interestRate, true);
    setFV(fv);
  ...
  return (
    <>
      <Head>
        <title>Future Value - Personal Finance app powered by Predifast</title>
      </Head>
